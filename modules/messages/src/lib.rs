...
decl_module! {
	pub struct Module<T: Config<I>, I: Instance = DefaultInstance> for enum Call where origin: T::Origin {
		...
		pub fn send_message(
			...
			).map(|sent_message| sent_message.pos_dispatch_info)
		}
...
struct SentMessage {
	...
	pub pos_dispatch_info: PostDispatchInfo,
}

/// Function that actually sends message.
fn send_message<T: Config<I>, I: Instance>(
	...
	Pallet::<T, I>::deposit_event(RawEvent::MessageAccepted(lane_id, nonce));

	Ok(SentMessage {
		nonce,
		pos_dispatch_info: PostDispatchInfo {
			actual_weight: Some(actual_weight),
			pays_fee: Pays::Yes,
		},
	})
